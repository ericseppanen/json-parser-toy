...
unsurprisingly it will return an `Option<T>` where `T` in this case is `&str`
...
So our `F` is a function that accepts one `I` and returns `IResult<I, O, E>`.
...
2. Implement the trait `nom::error::ParseError<I>` for your error type. This
